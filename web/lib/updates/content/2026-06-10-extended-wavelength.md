...
links:
  - { label: "PR#163", href: "https://github.com/hollisakins/campfire/pull/163" }
---
...
The extension is configurable (`[nirspec.stage2].extend_g140m_g235m`) and is off by default, but has been manually enabled for several programs in the CAMPFIRE database (e.g. [SPURS](https://campfire.hollisakins.com/nirspec/metadata/programs/spurs), [C3PO](/nirspec/metadata/programs/c3po).
