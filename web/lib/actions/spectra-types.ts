...
// 'band_mag' / 'band_snr' are the same deal on the photometry side (p_band).
export const SPECTRA_SORT_COLUMNS = ['spectrum_id', 'target_id', 'field', 'observation', 'program_slug', 'ra', 'dec', 'redshift', 'redshift_quality', 'redshift_auto', 'signal_to_noise', 'exposure_time', 'grating', 'distance', 'line_snr', 'band_mag', 'band_snr'] as const;

// Objects-mode sort columns (must match get_filtered_objects_paginated whitelist).
export const OBJECTS_SORT_COLUMNS = ['object_id', 'field', 'ra', 'dec', 'redshift', 'redshift_quality', 'n_targets', 'n_spectra', 'max_snr', 'max_exposure_time', 'photo_z', 'distance', 'line_snr', 'band_mag', 'band_snr'] as const;
...
export const VALID_SORT_COLUMNS = [
  ...
  'object_id', 'n_targets', 'n_spectra', 'photo_z', 'line_snr', 'band_mag', 'band_snr'
] as const;
