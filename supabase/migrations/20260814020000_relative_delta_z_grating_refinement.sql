-- compute_object_redshift_auto: make the PRISM-consistency tolerance
-- (1+z)-scaled — |z_grating - z_prism| / (1 + z_prism) < 0.01 — instead of
-- the absolute |dz| <= 0.03 cut, so the velocity window is uniform across
-- redshift. Selection logic is otherwise unchanged.
--
