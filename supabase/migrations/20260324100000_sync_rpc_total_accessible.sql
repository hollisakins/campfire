-- Add total_accessible_count to get_objects_for_sync.
--
-- During incremental sync (updated_since is set), total_count only reflects
-- objects modified since that timestamp. The client needs the full accessible
