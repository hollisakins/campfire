...
-- filter. The filter now decides on the viewer-visible grating set via the new
-- objects_matching_grating_filter() helper (hashed IN / NOT IN), keeping the
-- stored array tests as index-backed pre-filters.
--
