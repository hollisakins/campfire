-- Fix type mismatch: objects.redshift is numeric(10,6), not double precision.
-- RETURN QUERY requires exact type matches.
...
BEGIN
  ...
  LEFT JOIN programs pr ON pr.program_id = df.program_id
  ORDER BY
