-- Fix: get_filtered_spectra_paginated referenced s.thumbnail_path which
-- does not exist. The correct columns are thumbnail_svg_fnu and
-- thumbnail_svg_flambda (same bug as 20260319100002 fixed for the
-- objects paginated RPC).
