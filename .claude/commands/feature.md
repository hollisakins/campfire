...
Do NOT implement anything. Instead, comment on the issue with `gh issue comment $ARGUMENTS --body "<your analysis>"` containing:
...
End your comment with: "Let me know which direction to go and I'll implement it."
