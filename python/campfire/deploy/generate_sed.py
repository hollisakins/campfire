...
from campfire.deploy.generate_rgb import gen_rgb_image, get_source_pos
...
def _get_cosmos_paths():
    ...
    if hostname == 'patrick':
        image_data = {
            ...
            'f430m': '/V/maurice/mosaics/cosmos/f430m/mosaic_nircam_f430m_cosmos_30mas_{version}_{tile}_{ext}.fits',
            'f444w': '/V/maurice/mosaics/cosmos/f444w/mosaic_nircam_f444w_cosmos_30mas_{version}_{tile}_{ext}.fits',
            'f460m': '/V/maurice/mosaics/cosmos/f460m/mosaic_nircam_f460m_cosmos_30mas_{version}_{tile}_{ext}.fits',
